 ...
 *
 * หมายเหตุ:
 * - DHT11 ใช้เพียงขาเดียวก็วัดได้ทั้งอุณหภูมิและความชื้น
 * - ถ้า LDR เป็นแบบ Analog ต้องย้ายไป ADC pin (32/33/34/35/36/39)
 *   เพราะ GPIO22 ไม่รองรับ analogRead ใน ESP32
 */
